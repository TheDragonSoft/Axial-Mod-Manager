  ...
  return (
    <>
      ...
      <aside
        ...
        tabIndex={-1}
        className={`fixed inset-y-0 right-0 z-50 flex w-96 transform flex-col border-l border-line bg-surface transition-transform duration-200 ease-out outline-none motion-reduce:transition-none ${
